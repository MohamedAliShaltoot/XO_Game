            ...
            children: [
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderSide: const BorderSide(
                        color: Color.fromARGB(255, 4, 33, 56), width: 2),
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide: const BorderSide(
                        color: Color.fromARGB(255, 6, 42, 64), width: 2),
                    borderRadius: BorderRadius.circular(12),
                  ),
                ),
              ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderSide: const BorderSide(
                        color: Color.fromARGB(255, 19, 139, 214), width: 2),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderSide: const BorderSide(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, XoGameScreen.routeName,
                        arguments: PlayersModel(
                            player1: player1, player2: player2.text));
                  },
                  child: const Text(
                    "Play",
                    style: TextStyle(
